...
int main(void)
{
    ...
    // กำหนดค่า Timer 0 ให้เป็นโหมด Fast PWM (WGM02:0 = 011)
    TCCR0A = (1 << WGM01) | (1 << WGM00);  // ตั้งบิต WGM01 และ WGM00 ใน TCCR0A เพื่อเปิดใช้งานโหมด Fast PWM
    ...
    OCR0A = 51;   // ตั้งค่ารีจิสเตอร์เปรียบเทียบเอาท์พุต A เป็น 51 สำหรับรอบการทำงาน 20% (51/255 ≈ 0.2)
    OCR0B = 179;  // ตั้งค่ารีจิสเตอร์เปรียบเทียบเอาท์พุต B เป็น 179 สำหรับรอบการทำงาน 70% (179/255 ≈ 0.7)
